# Move select photos from an external camera SD card onto local drive in a custom 
# folder
...
# Photos on camera SD card are in the format: DSC_XXXX.JPG where XXXX is a four 
# digit number starting at 0001

# Improvements:
# - Check if an external drive is connected and give option to insert or do without 
# it
...
while True:
    ...
    # Where images are initially located (SD Card) - add your own directory here
    retrieval_path = retrieve_file(1)
    ...
    try:
        ...
        print("The path could not be created. Please check that the folder " + \
